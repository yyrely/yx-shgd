...
import com.yx.shgd.common.config.authorization.handler.PostJsonAuthenticationFailureHandler;
import com.yx.shgd.common.config.authorization.handler.PostJsonAuthenticationSuccessHandler;
import com.yx.shgd.common.config.authorization.handler.TokenAccessDeniedHandler;
import com.yx.shgd.common.config.authorization.handler.TokenAuthenticationEntryPoint;
...
public class SpringSecurityConf extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTH_WHITELIST =
        {"/swagger-resources/**", "/swagger-ui/**", "/swagger-ui.html",
                "/doc.html" ,"/v3/api-docs", "/webjars/**", "/api/user/login", "/file/**"};
